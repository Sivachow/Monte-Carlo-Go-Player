...
from pattern_util import PatternUtil, get_pattern_probs
...
class TreeNode(object):
    ...
    def select(self, exploration, max_flag):
        ...
        """
        return max(self._children.items(), key=lambda items:uct_val(self, items[0], items[1], exploration, max_flag,self.knowledge))
...
class MCTS(object):
    def __init__(self):
        ...
        self.toplay = BLACK
    def _playout(self, board, color,weights):
        """
